...
const Footer = () => {
    return (
        ...
        <section id="footer">
            ...
            alt="Logo"
          />
              <p className="footer-description"  > 5fffrfrfr Copyright © 2020 Nexcent ltd. <br/> All rights reserved</p>
              
              <ul className="footer-download">
              <Link className="social-link" to="/">
                <img className="social-logo" src={InstagramLink} alt="Logo" /></Link>
                <Link className="social-link" to="/">
                <img className="social-logo" src={BallLink} alt="Logo" /></Link>
                <Link className="social-link" to="/">
                <img className="social-logo" src={TwitterLink} alt="Logo" /></Link>
                <Link className="social-link" to="/">
                <img className="social-logo" src={InstagramLink} alt="Logo" /></Link>
              </ul>
          ...
          <ul className="footer-menu-wrapper">
              ...
              <ul className="footer-menu">
                  ...
                  <Link className="footer-link" to="/">Legal</Link>
